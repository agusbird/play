...
const UI = {
  ...
  draw: function () {
    switch (state.curr) {
      case state.getReady:
        document.getElementById("wait").classList.remove("delay");
        ...
        break;
      case state.gameOver:
        document.getElementById("wait").classList.add("delay");
...
SFX.start.src = "sfx/start.ogg";
SFX.flap.src = "sfx/flap.ogg";
SFX.score.src = "sfx/score.ogg";
SFX.hit.src = "sfx/hit.ogg";
SFX.die.src = "sfx/die.ogg";
